...
- **理由：** 三項論述強化：①判準節承認鐵律有多個根，不再宣稱單一判準涵蓋全部條文（尤其 C 段定價正當性、平台存活另有保護對象）；②B2 蝦幣回饋改採「平台歸屬」定性，明確與 A2 的區隔依據；③B1 停產出清條款增列「受控例外聲明」，承認此條確實可能讓原價買家看到更低價，以三重不可逆柵欄（停產不可逆、售完不補、SKU 上限 20%）換取死庫存出口，不假裝無傷。三項修訂均不涉及任何價格判定或數字變動。
